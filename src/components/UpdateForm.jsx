...
const UpdateForm = () => {
  ...
  useEffect(() => {
    axios
      .get(import.meta.env.VITE_REACT_APP_CATEGORY_COURSE + id)
      .then((res) => {
        setName(res.data.data.name), setPreview(res.data.data.imageUrl);
      })
  ...
  const updateCategory = async (e) => {
    ...
    try {
      await axios.patch(
        import.meta.env.VITE_REACT_APP_CATEGORY_COURSE + id,
        formData,
        {
          headers: {
